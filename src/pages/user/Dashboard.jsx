      ...
      <div className='mt-4 mb-1 p-3 bg-white rounded-box-shadow'>
        ...
        <div id='transactions' className='collapse show'>
                ...
                <tr height='58px'>
                  <td>
                    <img
                      ...
                      src='https://www.sellanycode.com/images/sellanycode-min.png'
                      alt=''
                    />
                  </td>
                  <td></td>
                      ...
                      <Tooltip title='Edit Item' placement='top'>
                        <Link to='/edite/item'>
                          <button className='btn btn-primary'>
                            <i className='fas text-white fa-pencil-alt'></i>
                          </button>
                        </Link>
                      </Tooltip>
          ...
          <div className='d-flex w-100 align-items-center justify-content-between'>
            <Link to={`${url}/transactions`} className='text-center'>
              <button className='btn btn-sm  btn-primary'>+ Upload Code</button>
            </Link>
            <Link to={`${url}/transactions`} className='text-center'>
              <button className='btn btn-sm  btn-primary'>
                View All Trancations
